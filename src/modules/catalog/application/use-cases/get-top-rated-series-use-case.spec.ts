...
import { GetTopRatedSeriesUseCase } from './get-top-rated-series-use-case'
...
let sut: GetTopRatedSeriesUseCase
...
describe('GetTopRatedSeriesUseCase', () => {
  beforeEach(() => {
    provider = new FakeCatalogProvider()
    cacheService = new CatalogCacheService(fakeRedis, provider)
    sut = new GetTopRatedSeriesUseCase(cacheService)
  })

  it('should return top rated series with pagination', async () => {
