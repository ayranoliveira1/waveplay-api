...
import { GetNowPlayingMoviesUseCase } from './get-now-playing-movies-use-case'
...
let sut: GetNowPlayingMoviesUseCase
...
describe('GetNowPlayingMoviesUseCase', () => {
  beforeEach(() => {
    ...
    sut = new GetNowPlayingMoviesUseCase(cacheService)
  })
