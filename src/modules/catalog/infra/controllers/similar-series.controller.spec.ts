...
import { SimilarSeriesController } from './similar-series.controller'
...
describe('SimilarSeriesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [SimilarSeriesController],
      providers: [
  ...
  it('should return 200 with similar series', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/series/1396/similar?page=1',
    )
