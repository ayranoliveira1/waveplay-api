...
import { PopularMoviesController } from './popular-movies.controller'
...
describe('PopularMoviesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [PopularMoviesController],
      providers: [
