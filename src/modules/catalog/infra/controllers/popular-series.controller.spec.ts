...
import { PopularSeriesController } from './popular-series.controller'
...
describe('PopularSeriesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [PopularSeriesController],
      providers: [
  ...
  it('should return 200 with popular series', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/series/popular?page=1',
    )
