...
import { OnTheAirSeriesController } from './on-the-air-series.controller'
...
describe('OnTheAirSeriesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [OnTheAirSeriesController],
      providers: [
  ...
  it('should return 200 with on the air series', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/series/on-the-air?page=1',
    )
