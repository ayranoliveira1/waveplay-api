...
import { SimilarMoviesController } from './similar-movies.controller'
...
describe('SimilarMoviesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [SimilarMoviesController],
      providers: [
  ...
  it('should return 200 with similar movies', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/movies/550/similar?page=1',
    )
