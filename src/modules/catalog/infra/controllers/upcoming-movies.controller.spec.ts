...
import { UpcomingMoviesController } from './upcoming-movies.controller'
...
describe('UpcomingMoviesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [UpcomingMoviesController],
      providers: [
  ...
  it('should return 200 with upcoming movies', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/movies/upcoming?page=1',
    )
