...
import { SeriesGenresController } from './series-genres.controller'
...
describe('SeriesGenresController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [SeriesGenresController],
      providers: [
  ...
  it('should return 200 with series genres', async () => {
