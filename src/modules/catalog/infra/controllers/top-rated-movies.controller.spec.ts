...
import { TopRatedMoviesController } from './top-rated-movies.controller'
...
describe('TopRatedMoviesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [TopRatedMoviesController],
      providers: [
  ...
  it('should return 200 with top rated movies', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/movies/top-rated?page=1',
    )
