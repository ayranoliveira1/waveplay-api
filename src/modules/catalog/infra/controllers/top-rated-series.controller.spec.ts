...
import { TopRatedSeriesController } from './top-rated-series.controller'
...
describe('TopRatedSeriesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [TopRatedSeriesController],
      providers: [
  ...
  it('should return 200 with top rated series', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/series/top-rated?page=1',
    )
