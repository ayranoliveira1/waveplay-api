...
import { AiringTodaySeriesController } from './airing-today-series.controller'
...
describe('AiringTodaySeriesController', () => {
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      controllers: [AiringTodaySeriesController],
      providers: [
  ...
  it('should return 200 with airing today series', async () => {
    const response = await request(app.getHttpServer()).get(
      '/catalog/series/airing-today?page=1',
    )
