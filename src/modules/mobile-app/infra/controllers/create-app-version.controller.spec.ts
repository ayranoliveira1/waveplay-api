...
import { CreateAppVersionController } from './create-app-version.controller'
...
describe('CreateAppVersionController', () => {
  beforeEach(async () => {
    testModule = await Test.createTestingModule({
      ...
      controllers: [CreateAppVersionController],
      providers: [
  ...
  it('should return 201 with the created version', async () => {
    asAdmin()
